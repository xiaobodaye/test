...
<head>
<link href="css/erweima.css" rel="stylesheet" type="text/css" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>河北中学</title>
<link href="css/style.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="js/jquery-1.8.2.min.js"></script>
<script type="text/javascript" src="js/solideForK13-min.js"></script>
<script type="text/javascript" src="js/ad_pic.js"></script>
...
<body>
 ...
 <!--第一部分内容-->
  ...
  <ul class="slider" id="idSlider">
    <li><img src="images/pic.jpg" width="280" height="210"/>
    <p>adfasdfsadf</p></li>
    <li><img src="images/pic.jpg" width="280" height="210"/>
     <p>adfasdfsadf</p></li>
    <li><img src="images/pic.jpg" width="280" height="210" usemap="#Map3" border="0"/>
  ...
  <ul class="num" id="idNum">
    ...
    <li>3</li>
           	  ...
           	  <div id="news">
                   <h1><img src="images/news_pic_title.gif" width="430" height="50" usemap="#Map2" border="0" />
          ...
          <div id="notice">
          	<h1><a href="#"><img src="images/30.gif" width="30" height="9" /></a></h1>
            <ul>
           	  <li><a href="#" ><img src="images/pot.gif" width="4" height="4" /> 河北中学男子篮球体育特长生招生简章 (2013-04-11)</a></li>
                   	<li><a href="#" ><img src="images/pot.gif" width="4" height="4" /> 河北中学音乐特长生复试名单 (2013-04-08)</a></li>
                    <li><a href="#"><img src="images/pot.gif" width="4" height="4" /> 河北中学2013年艺术特长生招生简章 (2013-03-01)</a></li>
                    <li><a href="#"><img src="images/pot.gif" width="4" height="4" /> 2012-2013第二学期考试、放假安排 (2013-02-25) </a></li>
            </ul>
          </div>
        </div>
 <!--第二部分内容-->
	  ...
	  <div id="no2">
        	<div class="news_content">
            	<h1><img src="images/news_jy_title.gif" width="480" height="40" usemap="#Map" border="0" alt="教研网" />
                  <map name="Map" id="Map">
                    <area shape="rect" coords="439,11,481,33" href="#" />
                  </map>
            	</h1>
         		<img src="images/news_jy_pic.gif" width="130" height="165" alt="tp" />
                 <ul>
            ...
            <div class="news_content" style="margin-left:45px; _margin-left:25px">
            	<h1><img src="images/news_dy_title.gif" width="480" height="40" usemap="#Map" border="0" alt="教研网" />
                  <map name="Map" id="Map">
                    <area shape="rect" coords="439,11,481,33" href="#" />
                  </map>
            	</h1>
         		<img src="images/news_dy_pic.gif" width="130" height="165" alt="tp" />
                <ul>
                	<li><a href="#">[公开课教学][图文]化学老师于文英举办观摩课活动</a> </li> 
					<li><a href="#">[公开课教学][图文]本部数学组组织公开课教学校调研 </a> </li> 
					<li><a href="#">[公开课教学][图文]生物老师开展观摩课活动</a> </li>  
 ...
 <!--第四部分内容-->
      <div id="no4">
      	<div id="synopsis">
   	     <img src="images/gnq.gif" width="258" height="260" usemap="#Map4" style="margin-top:10px;" border="0"/>
		...
		<div class="slide_content">
			<ul>
				<li>					
					<a href="#"><img src="images/tup.gif" alt=""></a>
					<p>校园美景</p>
			  </li>
				<li>					
					<a href="#"><img src="images/tup.gif" alt=""></a>
...
<div id="foot">	
  <div id="nr">
    	<div class="foot_link" >
        	<h1><img src="images/foot_link.gif" width="150" height="36" alt="友情链接" /></h1>
            <ul >
    	...
    	<div class="foot_link" >
        	<h1><img src="images/foot_school.gif" width="150" height="36" alt="友情链接" /></h1>
            <ul >
            	<li><a href="#">邯郸市第一中学的网站</a></li>
                <li><a href="#">邯郸市第一中学</a></li>
                <li><a href="#">邯郸市第一中学</a></li>
          ...
          <div class="foot_link">
        	<h1><img src="images/foot_down.gif" width="150" height="36" alt="资源下载" /></h1>
            <ul>
        	...
        	<h1><img src="images/foot_count.gif" width="150" height="36" alt="网站统计" /></h1>
            <ul>
            	<li>总访问量：2600700</li>
